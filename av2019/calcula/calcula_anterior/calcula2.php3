...
/*
 $str_rec0="SELECT DISTINCT Pesq_Satisfacao_Resp_Item.codigo_pesquisa
                  FROM Pesq_Satisfacao_Resp_Item, Pesquisa_Opiniao_Clientes2006
                  WHERE Pesq_Satisfacao_Resp_Item.codigo_pesquisa=Pesquisa_Opiniao_Clientes2006.codigo_pesquisa 
                  AND Pesquisa_Opiniao_Clientes2006.matricula='$lis_empr[0]' 
