...
function le_empregados()
{
 global $BD1;
 global $ANO_REF;
 $sql_matr="select cnpma.empregados.matr,cnpma.empregados.nome from cnpma.empregados, avaliacao.elegiveis where cnpma.empregados.tipo='e' and cnpma.empregados.situacao='a' and avaliacao.elegiveis.matr=cnpma.empregados.matr and avaliacao.elegiveis.ano='$ANO_REF' order by avaliacao.elegiveis.agrup_saad, cnpma.empregados.nome";
...
echo "<br>";
echo "LAYOUT - matricula:nome:media supervisor:media clientes:nota final";
