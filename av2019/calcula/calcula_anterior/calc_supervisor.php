...
function le_empregados()
{
 ...
 $sql_matr="select cnpma.empregados.matr,cnpma.empregados.nome from cnpma.empregados, avaliacao.2010_final where cnpma.empregados.tipo='e' 
 and cnpma.empregados.matr=avaliacao.2010_final.matr
 and cnpma.empregados.situacao='a' order by avaliacao.2010_final.agrup,cnpma.empregados.nome";
echo $sql_matr;
...
while ($lista=mysql_fetch_row($ret))
{
  ...
  echo $matr_ret .":". $nome;
  echo "<br>";
  $ret_func= busca_medias_competencia(1,$matr_ret,$ANO_BASE);
