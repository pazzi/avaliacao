...
include ("../func_avalia.php3");
   ...
   if (($_SERVER["HTTP_REFERER"] <> "http://$REFERER_SERVER/avaliacao/$AMBIENTE/rh/mapa.php") AND ($_SERVER["HTTP_REFERER"] <> "http://$REFERER_SERVER/avaliacao/$AMBIENTE/rh/rh_mostra.php3?ano=$ANO_REF"))
 
	{
    	echo "<a href=./index.php3>Entrada invalida</a>";
    	exit();
    	}
...
$str_agrupamento="SELECT $BD4.Agrupamento.cod_agrupamento, $BD4.Agrupamento.descricao 
                    FROM  $BD4.Agrupamento 
                    WHERE  $BD4.Agrupamento.ano_referencia='$ANO_REF'
                    ORDER BY  $BD4.Agrupamento.descricao";


$str_setor="SELECT  $BD4.setor.cod_setor, $BD4.setor.descricao 
                    FROM  $BD4.setor 
                    WHERE  $BD4.setor.ano='$ANO_REF'
                    ORDER BY  $BD4.setor.descricao";
