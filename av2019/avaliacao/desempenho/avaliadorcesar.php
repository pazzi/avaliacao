...
<html>
    ...
    <body>
        ...
        if (($data_atual == '2019-04-11') and ($hora_atual <= '12:00:00')) {
            $erroTipoCliente = '0';
        } else {
...
// Início: switch para 1ª vez que a tela é exibida
        ...
        switch ($oPesq) {
            case 'I': // Inclui dados da pesquisa
                ...
                <form method=post
                      action="<?= "avaliadorcesar.php?oPesq=$oPesq" . "C" ?>&<?= "parm=$parm" ?>">
                    ...
                    if ($erroTipoCliente == '3') {
                        ...
                        while ($dados_avaliacao = mysql_fetch_row($avaliacao_selecionada)) {
                            ...
                            $emp_login = 'cesar'; //xssafe($_COOKIE['cookie_user_aval']);
                        ...
                        <!-- p align=center>
                            <font size=+2><a class="link" href="../aval_mostra.php3?parm=1"><<
                                    Voltar para a lista</a> </font>
                        </p -->
                                ...
                                <table width="100%" border="0"> 
                                    ...
                                    while ($pesquisaSatisfacao = mysql_fetch_row($pesquisaSatisfacaoBD)) {
                                        ...
                                        if ($cod_perg_pesquisa == 0) {
                                            ...
                                            $link = "<a href=\"http://intranet.cnpma.embrapa.br/intranet/php3/indicadores_producao_2018.php?flag=I$matricula&ano=$ANO_REF\" target=\"_blank\">Mais informações</a>";
                                            
                                            //Engajamento com o trabalho - Indicadores de Engajamento	
                                            //$itemRespSatisfPesq->cod_pergunta == 8
                                            if ($itemRespSatisfPesq->cod_pergunta == 8) {
                                                ...
                                                $link = "<a href=\"http://intranet.cnpma.embrapa.br/intranet/php3/indicadores_engajamento_2018.php?flag=I$matricula&ano=$ANO_REF\" target=\"_blank\">Mais informações</a>";
                                            }
