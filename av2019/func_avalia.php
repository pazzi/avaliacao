...
##$EXCEPCOES="(304554,321737,353232,351289,336574,335358,356341,350575,294590,353476,349004,353501,350172,260748)"; 
$EXCEPCOES="(304554,321737,336574,335358,356341,294590,353476,335114,260748)";
...
#$BD3 = "avaliacao";
$BD4 = "AvaliacaoDesemp";
##$BD4 = "AvaliacaoDesempDesenv"; # ana paula
$BD5 = "ponto";
...
echo "<html>\n";
echo "<head>\n";
echo "<title>Bem-vindo ao Avalia��o de Competencias</title>";
...
echo "<b>A V A L I A � � O&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;D E&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; C O M P E T E N C I A S&nbsp;&nbsp;</b>\n";
echo "</td>\n";
echo "</tr>\n";
echo "</table></center>";
}
...
{
echo "<center><a href=\><font class=corpo><img src=\"/$VAR_IMAGEM/logomeioambiente.gif\" alt=\"In�cio - Embrapa Meio Ambiente\" WIDTH=\"530\" HEIGHT=\"85\" border=\"0\"></font></a></center>\n";
echo "<br>\n";
}
...
function obtem_nfi($agrup, $id_fonte)
        {
                        global $BD4;
#echo "aqui: agrup:$agrup, id_fonte:$id_fonte; BD4:$BD4<br>";
